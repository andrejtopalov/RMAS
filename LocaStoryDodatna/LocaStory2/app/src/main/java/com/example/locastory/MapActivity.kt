...

{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        storyList = intent.getSerializableExtra("storyList") as? ArrayList<Story> ?: ArrayList()
        Log.d("MapActivity", "Story List: $storyList")
    ...
    private fun addMarkersToMap(storyList: ArrayList<Story>) {
